...
public class Obfuscator
{
                        ...
                        ClassPool libraryClassPool) throws IOException
    {
        ...
        NameFactory fieldNameFactory = new SerialNameFactory("var_"); // new SimpleNameFactory();
        NameFactory methodNameFactory = new SerialNameFactory("sub_"); // new SimpleNameFactory();

        if (configuration.obfuscationDictionary != null)
        {
            fieldNameFactory = new DictionaryNameFactory(configuration.obfuscationDictionary,
                                                         fieldNameFactory);

            methodNameFactory = new DictionaryNameFactory(configuration.obfuscationDictionary,
                                                          methodNameFactory);
        }
        ...
        NameFactory specialFieldNameFactory = new SerialNameFactory("var__");
        NameFactory specialMethodNameFactory = new SerialNameFactory("sub__");
        ...
        programClassPool.classesAccept(
            new MultiClassVisitor(new ClassVisitor[]
            {
                ...
                new MemberNameConflictFixer(configuration.overloadAggressively,
                                            ...
                                            warningPrinter,
                new MemberObfuscator(configuration.overloadAggressively,
                                     specialFieldNameFactory,
                                     specialMethodNameFactory,
                                     specialDescriptorMap))))),
