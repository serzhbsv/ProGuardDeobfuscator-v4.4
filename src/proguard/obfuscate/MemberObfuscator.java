             ...
             MemberVisitor
{
    ...
    private final NameFactory    fieldNameFactory;
    private final NameFactory    methodNameFactory;
    ...
    public MemberObfuscator(boolean        allowAggressiveOverloading,
                            NameFactory    fieldNameFactory,
                            NameFactory    methodNameFactory,
                            Map            descriptorMap)
    {
    ...
    {
    	fieldNameFactory.reset();
    	methodNameFactory.reset();
    ...
    public void visitAnyField(Clazz clazz, Member member)
    {
        ...
        if (newName == null)
        {
            ...
            do
            {
                newName = fieldNameFactory.nextName();
            }
    ...
    public void visitAnyMethod(Clazz clazz, Member member)
    {
        ...
        if (newName == null)
        {
            ...
            do
            {
                newName = methodNameFactory.nextName();
            }
            while (nameMap.containsKey(newName));
